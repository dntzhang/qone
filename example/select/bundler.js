...
var FormTest = function (_Omi$Component) {
    ...
    _createClass(FormTest, [{
        ...
        value: function render() {
            return _index2['default'].x('form', { onsubmit: this.handleSubmit.bind(this) }, [_index2['default'].x('label', null, ["Pick your favorite La Croix flavor:", _index2['default'].x('select', { value: this.data.value, onchange: this.handleChange.bind(this) }, [_index2['default'].x('option', { value: "grapefruit" }, ["Grapefruit"]), _index2['default'].x('option', { value: "lime" }, ["Lime"]), _index2['default'].x('option', { value: "coconut" }, ["Coconut"]), _index2['default'].x('option', { value: "mango" }, ["Mango"])])]), _index2['default'].x('input', { type: "submit", value: "Submit" })]);
        }
    }]);
