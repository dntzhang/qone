...
/***/ function(module, exports, __webpack_require__) {
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        var TodoList = (function(_Omi$Component) {
            ...
            _createClass(TodoList, [{
                ...
                value: function render() {
                    return _index2['default'].h('ul', null, [this.data.items.map(function(item) {
        ...
        _index2['default'].tag('todo-list', TodoList)

        var TodoApp = (function(_Omi$Component2) {
            _inherits(TodoApp, _Omi$Component2)

            function TodoApp(data) {
                _classCallCheck(this, TodoApp)

                var _this2 = _possibleConstructorReturn(this, (TodoApp.__proto__ || Object.getPrototypeOf(TodoApp)).call(this, data))

                _this2.data = { items: [{ id: 1, text: 'Omi' }, { id: 2, text: 'AlloyTeam' }], text: '' }
            ...
            _createClass(TodoApp, [{
                ...
                key: 'render',
                value: function render() {
                    return _index2['default'].h('div', null, [_index2['default'].h('h3', null, ['TODO']), _index2['default'].h('todo-list', { items: this.data.items }), _index2['default'].h('form', { onSubmit: this.handleSubmit.bind(this) }, [_index2['default'].h('input', { onChange: this.handleChange.bind(this), value: this.data.text }), _index2['default'].h('button', null, ['Add #' + (this.data.items.length + 1)])])])
                }
            }])
        ...
        _index2['default'].render(new TodoApp(), 'body')
        /***/ },
    /* 16 */
    /***/ function(module, exports, __webpack_require__) {
        'use strict'
            ...
            _createClass(Component, [{
                ...
                value: function _mixAttr(current) {
                    ...
                    current.children.forEach(function(child) {
                        child.node && current._mixAttr(child)
                    })
                }
            }])
