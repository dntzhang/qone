...
/***/ function(module, exports, __webpack_require__) {
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        Omi.tag = function(name, ctor) {
            Omi.componentConstructor[name.toUpperCase()] = ctor
            Omi.customTags.push(name.toUpperCase())
            ctor.is = name.toUpperCase()
        ...
        var App = (function(_Omi$Component) {
            ...
            _createClass(App, [{
                ...
                value: function render() {
                    return _index2['default'].h('div', null, ['afsdfsd', _index2['default'].h('hello', { name: 'Omi' })])
                }
            }, {
                key: 'install',
 ...
 */
        ...
        var Component = (function() {
            ...
            _createClass(Component, [{
                ...
                value: function _generateCSS() {
                    ...
                    var shareAttr = name ? '__s_' + name.toLowerCase() : '__s_' + this.id
                ...
                value: function _normalize(root, parent, index, parentInstance) {
                    ...
                    if (_omi2['default'].scopedStyle && ps) {
                        if (this.constructor.is) {
                            ps['__s_' + this.constructor.is.toLowerCase()] = ''
                        }
                        ps['__s_' + this.id] = ''
                    }
                    // 编译啥时候处理?
                ...
                value: function _mixAttr(current) {
                    ...
                    current.children.forEach(function(child, index) {
                        ...
                        child.node = _omi2['default'].$('[' + child._omi_scoped_attr + ']', current.node)
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        _index2['default'].tag('aa', _hello2['default'])
        ...
        var Hello = (function(_Omi$Component) {
            ...
            _createClass(Hello, [{
                ...
                key: 'render',
                value: function render() {
                    return _index2['default'].h('div', { onclick: this.clickHandler.bind(this) }, ['Hello, ', this.data.name, _index2['default'].h('aa', null)])
                }
            }])
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        var Hello = (function(_Omi$Component) {
            ...
            _createClass(Hello, [{
                ...
                key: 'render',
                value: function render() {
                    return _index2['default'].h('div', { onclick: this.clickHandler.bind(this) }, ['Hello, ', this.data.name])
                }
            }])
