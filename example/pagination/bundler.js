        ...
        var Main = (function(_Omi$Component) {
            ...
            _createClass(Main, [{
                ...
                value: function render() {
                    return _index2['default'].h('div', null, [_index2['default'].h('h1', null, ['Pagination Example']), _index2['default'].h('content', { 'omi-name': 'content', 'omi-id': 'content' }), _index2['default'].h('pagination', {
                        name: 'pagination',
                        total: 100,
                        pageSize: 10,
                        numEdge: 1,
 ...
 */
    ...
    /***/ function(module, exports, __webpack_require__) {
            ...
            _createClass(Pagination, [{
                ...
                value: function render() {
                    ...
                    if (interval[0] > 0 && opt.numEdge > 0) {
                        ...
                        if (opt.numEdge < interval[0] && opt.ellipseText) {
                            arr.push(_index2['default'].h('span', null, [' ', opt.ellipseText]))
                        }
                    }
                    // 内部的链接
                    ...
                    return _index2['default'].h('div', { 'class': 'pagination' }, [arr.map(function(p) {
                        return p
                    }), ' '])
                }
            }, {
                ...
                value: function getPrev() {
                    if (this.data.currentPage === 0) {
                        return _index2['default'].h('span', { 'class': 'current prev' }, [this.data.prevText])
                    }
                    return _index2['default'].h('a', { onclick: '', href: this.data.linkTo, 'class': 'prev' }, [this.data.prevText])
                }
            }, {
                key: 'getNext',
                value: function getNext() {
                    if (this.data.currentPage === this.pageNum - 1) {
                        return _index2['default'].h('span', { 'class': 'current next' }, [this.data.nextText])
                    }
                    return _index2['default'].h('a', { onclick: '', href: this.data.linkTo, 'class': 'next' }, [this.data.nextText])
                }
            }, {
                key: 'getItem',
                value: function getItem(pageIndex, text) {
                    ...
                    if (this.data.currentPage === pageIndex) {
                        return _index2['default'].h('span', { 'class': 'current' }, [' ', text, ' '])
                    }
                    return _index2['default'].h('a', { 'class': 'link',
                        onclick: function onclick(e) {
                            _this2.goto(pageIndex, e)
                        },
        ...
        _index2['default'].tag('pagination', Pagination)
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        var Content = (function(_Omi$Component) {
            ...
            _createClass(Content, [{
                ...
                key: 'render',
                value: function render() {
                    return _index2['default'].h('div', { 'class': 'content' }, ['i am page ', this.data.index])
                }
            }])
        ...
        _index2['default'].tag('content', Content)
