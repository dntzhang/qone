        ...
        var App = (function(_Omi$Component) {
            ...
            _createClass(App, [{
                ...
                value: function render() {
                    return _index2['default'].h('notes-list', { a: 'a', 'class': 'sfds' }, [_index2['default'].h('span', null, ['hello']), _index2['default'].h('span', null, ['world'])])
                }
            }])
 ...
 */
    ...
    /***/ function(module, exports, __webpack_require__) {
        ...
        var NotesList = (function(_Omi$Component) {
            _inherits(NotesList, _Omi$Component)
            ...
            _createClass(NotesList, [{
                key: 'render',
                value: function render() {
                    return _index2['default'].h('ol', null, [this.data.children.map(function(child) {
                        return _index2['default'].h('li', null, [child])
                    })])
                }
            }])
