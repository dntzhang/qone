...
var App = function (_Omi$Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _index2['default'].x('div', null, [_index2['default'].x('div', null, [" ", this.data.demoName]), _index2['default'].x('tree', { root: this.data.rootNode })]);
        }
    }]);
...
var Tree = function (_Omi$Component) {
    ...
    _createClass(Tree, [{
        ...
        key: 'render',
        value: function render() {
            return _index2['default'].x('ul', null, [this.data.root.nodes.map(function (child) {
...
var TreeNode = function (_Omi$Component) {
    ...
    _createClass(TreeNode, [{
        ...
        value: function render() {
            ...
            return _index2['default'].x('li', { 'data-node-id': this.data.root.id, draggable: "true", ondragstart: this.dragStartHandler.bind(this), ondragleave: this.dragLeaveHandler.bind(this), ondrop: this.dropHandler.bind(this), ondragover: this.dragOverHandler.bind(this) }, [_index2['default'].x('div', { 'data-node-id': this.data.root.id }, [this.data.root.name]), list.length > 0 && _index2['default'].x('ul', { 'data-node-id': this.data.root.id }, [list])]);
        }
    }]);
