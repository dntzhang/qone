...
var _todoApp = __webpack_require__(10);
...
function patchOp(vpatch, domNode, renderOptions) {
    ...
    switch (type) {
        ...
        case 'ORDER':
            ...
            return domNode;
        case 'PROPS':
            (0, _applyProperties2['default'])(domNode, patch, vNode.properties);
            return domNode;
        default:
            return domNode;
    }
...
var TodoApp = function (_Omi$Component) {
    ...
    function TodoApp(data) {
        ...
        return _possibleConstructorReturn(this, (TodoApp.__proto__ || Object.getPrototypeOf(TodoApp)).call(this, data));
    }
        ...
        value: function render() {
            return Omi.x(
                ...
                Omi.x(
                    ...
                    Omi.x('input', { onChange: this.handleChange.bind(this), value: this.$store.text }),
                    Omi.x(
                        'button',
                        null,
