	...
	var App = function (_Omi$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _omix2.default.x('div', null, [_omix2.default.x('ul', null, [_omix2.default.x('li', null, [_omix2.default.x('a', { 'omi-router': true, to: "/" }, ["Home"])]), _omix2.default.x('li', null, [_omix2.default.x('a', { 'omi-router': true, to: "/about" }, ["About"])]), _omix2.default.x('li', null, [_omix2.default.x('a', { 'omi-router': true, to: "/user-list" }, ["UserList"])])]), _omix2.default.x('div', { id: "view" })]);
	        }
	    }]);
	...
	var Home = function (_Omi$Component) {
	    ...
	    _createClass(Home, [{
	        ...
	        value: function render() {
	            ...
	            return _omi2.default.x('div', null, ["Home"]);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var About = function (_Omi$Component) {
	    ...
	    _createClass(About, [{
	        key: 'render',
	        value: function render() {
	            return _omi2.default.x('div', null, ["About"]);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var User = function (_Omi$Component) {
	    ...
	    _createClass(User, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return _omi2.default.x('div', null, [_omi2.default.x('button', { onclick: this.back.bind(this) }, ["back"]), _omi2.default.x('ul', null, [_omi2.default.x('li', null, ["name:", this.name]), _omi2.default.x('li', null, ["age:", this.age]), _omi2.default.x('li', null, ["sex:", this.sex]), _omi2.default.x('li', null, ["category:", this.category])])]);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserList = function (_Omi$Component) {
	    ...
	    _createClass(UserList, [{
	        key: 'render',
	        value: function render() {
	            return _omi2.default.x('ul', null, [_omi2.default.x('li', null, [_omi2.default.x('a', { 'omi-router': true, to: "/user/yanagao/category/js" }, ["yanagao"])]), _omi2.default.x('li', null, [_omi2.default.x('a', { 'omi-router': true, to: "/user/vorshen/category/html" }, ["vorshen"])]), _omi2.default.x('li', null, [_omi2.default.x('a', { 'omi-router': true, to: "/user/dntzhang/category/css" }, ["dntzhang"])])]);
	        }
	    }]);
